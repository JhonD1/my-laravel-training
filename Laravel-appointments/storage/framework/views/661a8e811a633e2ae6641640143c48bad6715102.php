...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.edit')); ?> <?php echo e(trans('cruds.appointment.title_singular')); ?>

    </div>

    <div class="card-body">
        <form action="<?php echo e(route("admin.appointments.update", [$appointment->id])); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\john\Documents\Laravel-Appointments\resources\views/admin/appointments/edit.blade.php ENDPATH**/ ?>